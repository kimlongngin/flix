...
require 'spec_helper'
describe "Viewing a list of reviews"
		it "shows the reviews for a specific movie" do
			
			movie1 = Movie.create(movie_attributes(title: "Spider-Man"))
	    	...
	    	exspect(page).to have_text(review2.name)
	    	exspect(page).not_to have_text(review3.name)	
		end	
	end
end